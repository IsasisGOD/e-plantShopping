            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((item, index) => (
                        <div key={index}>
                            <h1 ><div style={{ display: "flex", margin: "20px auto 0", justifyContent: "center", maxWidth: "30ch", borderTop: "2px solid black", borderBottom: "2px solid black" }}>{item.category}</div></h1>
